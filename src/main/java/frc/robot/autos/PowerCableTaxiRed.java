...
public class PowerCableTaxiRed extends SequentialCommandGroup {
  Swerve swerve;
  ArmSub armsub;
  Gripper gripper;
  Joystick controller;
  ...
  public PowerCableTaxiRed(Swerve swerve, ArmSub armsub, Gripper gripper) {
    this.swerve = swerve;
    this.armsub = armsub;
    ...
    TrajectoryConfig configrev = new TrajectoryConfig(
        ...
        TrajectoryGenerator.generateTrajectory(List.of(/* swerve.getAprilTagEstPosition(), */
            new Pose2d(13.94, 0.5, new Rotation2d(0)),
            new Pose2d(14.72, 0.5, new Rotation2d(0))),
        config);
        Trajectory traj3 =
        TrajectoryGenerator.generateTrajectory(List.of(/* swerve.getAprilTagEstPosition(), */
            new Pose2d(14.57, 0.5, new Rotation2d(0)),
            new Pose2d(12.69, 0.5, new Rotation2d(0))),
        configrev);

        Trajectory traj4 =
        TrajectoryGenerator.generateTrajectory(List.of(/* swerve.getAprilTagEstPosition(), */
            new Pose2d(12.69, 0.5, new Rotation2d(0)),
            new Pose2d(11.14, 0.5, new Rotation2d(0))),
        configrev);
        Trajectory traj5 =
        TrajectoryGenerator.generateTrajectory(List.of(/* swerve.getAprilTagEstPosition(), */
            new Pose2d(11.14, 0.5, new Rotation2d(0)),
            new Pose2d(12.84, 0.5, new Rotation2d(0))),
        config);
