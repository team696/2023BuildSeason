...
public class LockToGamePiece extends CommandBase {
     ...
     * Driver control
     */
    public LockToGamePiece(Swerve s_Swerve, Joystick controller, int translationAxis, int strafeAxis,  boolean fieldRelative, boolean openLoop, int pipeline) {
